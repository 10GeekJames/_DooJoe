...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        services
            .AddDojoSurveysDbContext(connectionString);
            ...
            .AddSwaggerGen(c =>
            {
                c.SwaggerDoc(
                    "v1",
                        new OpenApiInfo
                        {
                            Title = appSettings!.Endpoints.DojoSurveysApiName,
                            Version = appSettings!.Endpoints.DojoSurveysApiVersion
                        });
                c.EnableAnnotations();
            });
    ...
    services
        .AddJwtBearer("Bearer",
            options =>
            {
                ...
                options.Audience = "dojoSurveys_primary_api_swaggerui";
    ...
    public void ConfigureContainer(ContainerBuilder builder)
    {
        ...
        builder.RegisterModule(new DojoSurveysApiModule(isInDevelopment));
    }
