...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        // default to DOJOSURVEYSAccountModuleConnectionString ENVVAR
        string connectionString =
            Configuration.GetConnectionString("Active"); //Configuration.GetConnectionString("DefaultConnection");
        var appSettings = Configuration.Get<AppSettings>();
        services.AddSingleton<AppSettings>(appSettings);
        services.AddAutoMapper(typeof(KnownUserMap).GetTypeInfo().Assembly);
        ...
        services.AddSingleton<SeedAccountModuleDataDOJOSURVEYSClients>();
        ...
        services.AddCors(opt =>
            {
                opt
                    ...
                    {
                        builder
                            .WithOrigins("https://dooJoe.com", "http://dooJoe.com:5020", "http://localhost:5020")
                            .AllowAnyHeader()
                            .AllowAnyMethod()
                            .WithExposedHeaders("*");
                    });
        ...
        services
            ...
            .AddJwtBearer("Bearer",
                options =>
                {
                    ...
                    options.Audience = "DooJoeClient_api_swaggerui";
