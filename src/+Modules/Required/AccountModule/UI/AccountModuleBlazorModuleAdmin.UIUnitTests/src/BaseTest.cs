...
public class BaseTest
{
    ...
    public BaseTest()
    {
        ...
        var mockModuleTestComponentLocalizer = Mock.Create<IStringLocalizer<ModuleTest>>();
        ctx.Services.AddSingleton<IStringLocalizer<ModuleTest>>(mockModuleTestComponentLocalizer);
