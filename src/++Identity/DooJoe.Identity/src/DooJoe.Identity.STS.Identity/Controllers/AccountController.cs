...
using DooJoe.Identity.STS.Identity.Configuration;
using DooJoe.Identity.STS.Identity.Helpers;
using DooJoe.Identity.STS.Identity.Helpers.Localization;
using DooJoe.Identity.STS.Identity.ViewModels.Account;

namespace DooJoe.Identity.STS.Identity.Controllers
{
    [SecurityHeaders]
    [Authorize]
        ...
        where TKey : IEquatable<TKey>
    {
        ...
        private async Task<LoggedOutViewModel> BuildLoggedOutViewModelAsync(string logoutId)
        {
            ...
            {
                vm.PostLogoutRedirectUri = "http://localhost:5020";
            }
            else
            {
                vm.PostLogoutRedirectUri = "https://doojoe.com";
            }
