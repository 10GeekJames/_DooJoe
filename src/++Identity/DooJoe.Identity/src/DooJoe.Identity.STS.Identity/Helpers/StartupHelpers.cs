...
using DooJoe.Identity.STS.Identity.Configuration.ApplicationParts;
using DooJoe.Identity.STS.Identity.Configuration.Constants;
using DooJoe.Identity.STS.Identity.Configuration.Interfaces;
