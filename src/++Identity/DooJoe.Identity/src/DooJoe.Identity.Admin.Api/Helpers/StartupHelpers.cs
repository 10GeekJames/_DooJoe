...
using DooJoe.Identity.Admin.Api.Configuration.ApplicationParts;
using DooJoe.Identity.Admin.Api.Configuration.AuditLogging;
using DooJoe.Identity.Admin.Api.Configuration.Constants;
using DooJoe.Identity.Admin.Api.Helpers.Localization;
...
namespace DooJoe.Identity.Admin.Api.Helpers
{
